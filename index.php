    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title"> Robin Kumar Singh</h1>
                <h6 class="header-mono" > Web PHP Developer</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        <h5 class="brand-title">Robin Singh</h5>
                        <div class="brand-subtitle">Web PHP Developer</div>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="#portfolio" class="nav-link">Skills</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A Web PHP Developer Located In Our Lovely Earth</h5>
                <p class="mt-20"></p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 25/08/1994</li>
                    <li><span>Email</span> : robinjobs2510@gmail.com</li>
                    <li><span>Phone</span> : + (91) 8826791441</li>
                    <li><span>Skype</span> : Robin Kumar SIngh </li>
                    <li><span>Address</span> :  New Ashok Nagar (Delhi).</li>
                </ul>
                <ul class="social-icons pt-3">
